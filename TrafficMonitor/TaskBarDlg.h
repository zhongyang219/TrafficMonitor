...
protected:
	...
	std::wstring m_scroll_plugin_id;
	int m_scroll_interval{ 3000 };
	int m_scroll_start_index{ 0 };
	UINT_PTR m_scroll_timer{ 0 };

	bool CheckScrollModeEnabled() const;
	std::vector<CommonDisplayItem> GetScrollingItems() const;
	void UpdateScrollIndex();
	int GetScrollingItemCount() const;
